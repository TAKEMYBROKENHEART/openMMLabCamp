...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CustomDataset',
        data_root='/root/mmpretrain/dataset/fruit_data/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='RandomResizedCrop', scale=224),
            dict(type='RandomFlip', prob=0.5, direction='horizontal'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='CustomDataset',
        data_root='/root/mmpretrain/dataset/fruit_data/val',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='ResizeEdge', scale=256, edge='short'),
            dict(type='CenterCrop', crop_size=224),
...
log_level = 'INFO'
load_from = '/root/mmpretrain/exp/best_accuracy_top1_epoch_89.pth'
resume = False
